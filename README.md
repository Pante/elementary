...
**Please view the [stable branch](https://github.com/Pante/elementary/tree/stable) for a production version. Elementary and Utilitary requires Java 11+. Satisfactory requires Java 17. [Why Java 11?](https://github.com/Pante/elementary/wiki/FAQ#why-does-elementary-require-java-11-and-above) Read the [wiki](https://github.com/Pante/elementary/wiki) or check out the [Gradle demo project](https://github.com/toolforger/elementary-demo) to get started!**
